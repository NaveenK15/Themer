...
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __rt_box(__rt_registered.rgba.apply(__rt.registered, __rt_applySpreadArgs([
    new __Numeric(53), 
    new __Numeric(133), 
    new __Numeric(122), 
    new __Numeric(0.88671875), 
    __udf]))), 1);
...
__rt_setDynamic("$base-dark-color", __rt_getGlobalDefault("$base_dark_color") || __rt_box((__rt.functions.material_color || material_color__fn).apply(__rt.functions, __rt_applySpreadArgs([
    __rt_get("$base_color_name"), 
    new __Text("700", "'")]))), 6);
__rt_setDynamic("$base-pressed-color", __rt_getGlobalDefault("$base_pressed_color") || __rt_box(__rt.registered.darken.apply(__rt.registered, __rt_applySpreadArgs([
